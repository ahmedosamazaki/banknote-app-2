  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-slate-50 via-white to-slate-50 dark:from-slate-950 dark:via-slate-900 dark:to-slate-950 flex flex-col items-center justify-center px-6 py-10" dir="rtl">
      <div className="w-full max-w-sm flex flex-col items-center text-center">
        <div className="w-24 h-24 bg-white rounded-3xl shadow-2xl shadow-emerald-500/10 flex items-center justify-center overflow-hidden mb-5 animate-scale-in border border-slate-200 dark:border-transparent">
        ...
        <p className="text-emerald-600 dark:text-emerald-400 text-xs font-semibold tracking-widest mt-1.5 uppercase">
          {COMPANY_TAGLINE}
        </p>
